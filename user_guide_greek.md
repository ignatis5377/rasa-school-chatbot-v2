...
Αν τρέχετε το Chatbot σε απομακρυσμένο server (π.χ. μέσω SSH), η εντολή `streamlit run` δεν θα μπορέσει να ανοίξει αυτόματα browser. 

**Βήμα 1: Εκκίνηση της Εφαρμογής**
Μέσα στο SSH, τρέξτε την εντολή:
`streamlit run admin_app.py --server.headless true --server.port 8501`
